...
@section('content')
  <div class="container">
      ...
      <div class="col-12 col-xl-11 col-xxl-9">
        <div class="card mb-3">
          ...
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link{{ ($tab === 'cars') ? ' active': '' }}" id="cars-tab" data-bs-toggle="tab" data-bs-target="#cars-tab-pane" type="button" role="tab" aria-controls="cars-tab-pane" aria-selected="false"><i class="fas fa-cars"></i> Vehículos</button>
            </li>
            <li class="nav-item" role="presentation">
          ...
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade p-2{{ $tab ? '': ' show active' }}" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
              <div class="text-end">
                <a href="{{ route('orders.create') . '?code=' . $client->id }}" class="btn btn-success"><i class="fas fa-plus-circle"></i><span class="d-none d-md-inline"> Agregar</span></a>
              </div>
            ...
            <div class="tab-pane fade p-2{{ ($tab === 'cars') ? ' show active': '' }}" id="cars-tab-pane" role="tabpanel" aria-labelledby="cars-tab" tabindex="0">
              <div class="text-end">
                <a href="{{ route('cars.create') . '?code=' . $client->id }}" class="btn btn-success"><i class="fas fa-plus-circle"></i><span class="d-none d-md-inline"> Agregar</span></a>
              </div>
    ...
    <div class="row justify-content-center">
      <div class="col-12 col-xl-11 col-xxl-9 text-end">
        <a href="{{ route('clients.index') }}" class="btn btn-secondary my-1"><i class="fas fa-arrow-circle-left"></i> Clientes</a>
      </div>
    </div>
  </div>
